...
def main():
    ...
    def save_server_config():
        ...
        try:
            ...
            message.warning(config_window, 'Ошибка', 'Порт должен быть числом', QMessageBox.Ok)
        else:
            ...
            if 1023 < port < 65536:
                ...
                with open(f"{dir_path}/{'server.ini'}", 'w') as conf:
                    config.write(conf)
                    message.information(config_window, 'OK', 'Настройки успешно сохранены!', QMessageBox.Ok)
            else:
                message.warning(config_window, 'Ошибка', 'Порт должен быть от 1024 до 65536', QMessageBox.Ok)
